...
analysis. This graph does show general trends in average temepature in
...
```
    ...
    ##   id           year month   day  prcp  snow  snwd  tmax  tmin
    ##   <chr>       <int> <chr> <int> <dbl> <int> <int> <dbl> <dbl>
    ## 1 US1NYAB0001  2007 11       17   0.3     3     0    NA    NA
    ## 2 US1NYAB0001  2007 11       24   0.3     3     0    NA    NA
    ## 3 US1NYAB0001  2007 11       26   0.8     5    NA    NA    NA
    ## 4 US1NYAB0001  2007 11       28   0.8     5     0    NA    NA
    ## 5 US1NYAB0001  2007 12        1   4.6    64    64    NA    NA
    ## # … with 172,566 more rows
    ## # ℹ Use `print(n = ...)` to see more rows
